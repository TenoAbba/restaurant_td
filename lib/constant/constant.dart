...
import 'package:restaurant_td/models/permission_model.dart';
...
class Constant {
  ...
  static String mapAPIKeyIOS = "AIzaSyCxbvwu-lt3RifZ1BWagajW32pc4NihoWo";

  static String mapAPIKey = defaultTargetPlatform == TargetPlatform.android
      ? mapAPIKeyAndroid
      : mapAPIKeyIOS;
  ...
  static List<PermissionModel> permissionList = [
    PermissionModel(
        title: 'Add Story', isAdd: false, isView: false, isDelete: false),
    PermissionModel(
        title: 'Advertisement', isAdd: false, isView: false, isDelete: false),
    PermissionModel(title: "Restaurant Information's", isView: false),
    PermissionModel(
        title: 'Manage Products', isAdd: false, isView: false, isDelete: false),
    PermissionModel(
        title: 'Woking Hours', isAdd: false, isView: false, isDelete: false),
    PermissionModel(
        title: 'Withdraw Method', isAdd: false, isView: false, isDelete: false),
    PermissionModel(
        ...
        isDelete: false),
    PermissionModel(
        title: 'Employee Role', isAdd: false, isView: false, isDelete: false),
    PermissionModel(
        title: 'All Employee', isAdd: false, isView: false, isDelete: false),
    PermissionModel(title: 'Add Dine in', isAdd: false, isView: false),
    PermissionModel(title: 'Dine in Request', isAdd: false, isView: false),
    PermissionModel(
        title: 'Offers', isAdd: false, isView: false, isDelete: false),
    PermissionModel(
  ...
  static String amountShow({required String? amount}) {
    final value =
        (amount == null || amount.isEmpty) ? 0.0 : double.parse(amount);
  ...
  static sendMail(
    ...
    if (mailSettings == null) {
      print('Mail settings not loaded yet, cannot send mail.');
      return;
    }
  ...
  static bool getEmployeeRolePermission({
    ...
    if (permission == null ||
        permission.title == null ||
        permission.title == '') {
      return false;
    }

    switch (pType) {
      case ActionType.isAdd:
        return permission.isAdd == true;
      case ActionType.isView:
