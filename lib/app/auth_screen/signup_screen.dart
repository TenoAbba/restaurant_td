...
import 'package:restaurant_td/controller/signup_controller.dart';
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    RoundedButtonFill(
                      title: controller.isSigningUp.value
                          ? "Please wait...".tr
                          : "Signup".tr,
                      color: controller.isSigningUp.value
                          ? AppThemeData.grey400
                          : AppThemeData.secondary300,
                      textColor: AppThemeData.grey50,
                      onPress: () async {
                        // Block repeated taps: every tap sends another
                        // confirmation e-mail and triggers Supabase's
                        // "email rate limit exceeded" (429) error.
                        if (controller.isSigningUp.value) return;
