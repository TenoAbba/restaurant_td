...
import 'package:restaurant_td/controller/working_hours_controller.dart';
    ...
    return GetX(
        ...
        builder: (controller) {
          return Scaffold(
            ...
            bottomNavigationBar: (Constant.getEmployeeRolePermission(module: "Working Hours", pType: ActionType.isAdd) == false)
                ? null
                : Container(
                    color: themeChange.getThem() ? AppThemeData.grey900 : AppThemeData.grey50,
                    padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 10),
