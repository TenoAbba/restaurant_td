...
import 'package:restaurant_td/app/offer_screens/add_edit_offer_screen.dart';
import 'package:restaurant_td/constant/constant.dart';
import 'package:restaurant_td/constant/show_toast_dialog.dart';
import 'package:restaurant_td/controller/offer_controller.dart';
    ...
    return GetX(
        ...
        builder: (controller) {
          return Scaffold(
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          InkWell(
                                            ...
                                            onTap: () {
                                              if (Constant.getEmployeeRolePermission(module: "Offers", pType: ActionType.isAdd) == true) {
                                          ...
                                          if (Constant.getEmployeeRolePermission(module: "Offers", pType: ActionType.isDelete) == true)
                                            InkWell(
                                              splashColor: Colors.transparent,
                                              onTap: () async {
            ...
            floatingActionButton: Constant.getEmployeeRolePermission(module: "Offers", pType: ActionType.isAdd) == false
                ? null
