...
import 'package:restaurant_td/app/product_screens/add_product_screen.dart';
...
import 'package:restaurant_td/controller/product_list_controller.dart';
            ...
            appBar: AppBar(
              ...
              actions: [
                (((Constant.isRestaurantVerification == true && controller.userModel.value.isDocumentVerify == false) ||
                        ...
                        Constant.getEmployeeRolePermission(module: "Manage Products", pType: ActionType.isAdd) == false)
                    ? const SizedBox()
                    : InkWell(
                            ...
                            ? Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    if (Constant.getEmployeeRolePermission(module: "Manage Products", pType: ActionType.isAdd) == true)
                                      RoundedButtonFill(
                                            ...
                                            child: Column(
                                              children: [
                                                ...
                                                Row(
                                                  ...
                                                  children: [
                                                    Expanded(
                                                      child: (Constant.getEmployeeRolePermission(module: "Manage Products", pType: ActionType.isDelete) == false)
                                                          ? SizedBox()
                                                          : InkWell(
                                                              splashColor: Colors.transparent,
                                                              onTap: () async {
