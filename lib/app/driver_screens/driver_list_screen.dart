...
import 'package:restaurant_td/app/driver_screens/add_driver_screen.dart';
...
import 'package:restaurant_td/controller/driver_list_controller.dart';
            ...
            appBar: AppBar(
              ...
              actions: [
                (((Constant.isRestaurantVerification == true && Constant.userModel?.isDocumentVerify == false) ||
                        ...
                        Constant.getEmployeeRolePermission(module: "Manage Delivery Man", pType: ActionType.isAdd) == false)
                    ? SizedBox()
                    : InkWell(
                            ...
                            ? Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    if (Constant.getEmployeeRolePermission(module: "Manage Delivery Man", pType: ActionType.isAdd) == true)
                                      RoundedButtonFill(
