...
import 'package:restaurant_td/controller/dine_in_create_controller.dart';
    ...
    return GetX(
        ...
        builder: (controller) {
          return Scaffold(
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                            ...
                            children: [
                              ...
                              Transform.scale(
                                ...
                                child: CupertinoSwitch(
                                  ...
                                  onChanged: (value) {
                                    if (Constant.getEmployeeRolePermission(module: "Dine in Restaurant", pType: ActionType.isAdd) == true) {
                          ...
                          TextFieldWidget(
                            enable: Constant.getEmployeeRolePermission(module: "Dine in Restaurant", pType: ActionType.isAdd) == true,
            ...
            bottomNavigationBar: Constant.getEmployeeRolePermission(module: "Dine in Restaurant", pType: ActionType.isAdd) == false
                ? null
                : Container(
                    color: themeChange.getThem() ? AppThemeData.grey900 : AppThemeData.grey50,
