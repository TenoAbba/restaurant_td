...
import 'package:restaurant_td/app/add_advertisement_screen/add_advertisement_screen.dart';
import 'package:restaurant_td/app/add_advertisement_screen/view_advertisement_screen.dart';
import 'package:restaurant_td/app/chat_screens/admin_inbox_screen.dart';
import 'package:restaurant_td/constant/constant.dart';
import 'package:restaurant_td/controller/advertisement_list_controller.dart';
        ...
        builder: (controller) {
          return DefaultTabController(
            ...
            child: Scaffold(
              ...
              bottomNavigationBar: Constant.getEmployeeRolePermission(module: "Advertisement", pType: ActionType.isAdd) == false
                  ? null
                  : Container(
                ...
                Positioned(
                  ...
                  child: PopupMenuButton<String>(
                    ...
                    itemBuilder: (context) => [
                      ...
                      if (Constant.getEmployeeRolePermission(module: "Advertisement", pType: ActionType.isAdd) == true)
                        PopupMenuItem(
                          onTap: () {
                      ...
                      if (Constant.getEmployeeRolePermission(module: "Advertisement", pType: ActionType.isDelete) == true)
                        PopupMenuItem(
                          onTap: () async {
