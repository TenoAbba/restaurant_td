...
import 'package:restaurant_td/controller/add_advertisement_controller.dart';
...
class AddAdvertisementScreen extends StatelessWidget {
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              DropdownButtonFormField<String>(
                                  ...
                                  value: controller.selectedAdvertisementType.value == '' || controller.selectedAdvertisementType.value.isEmpty ? null : controller.selectedAdvertisementType.value,
                                  onChanged: (value) {
  ...
  buildProfileBottomSheet(BuildContext context, AddAdvertisementController controller) {
  ...
  buildCoverBottomSheet(BuildContext context, AddAdvertisementController controller) {
    return showModalBottomSheet(
        context: context,
        builder: (context) {
          final themeChange = Provider.of<DarkThemeProvider>(context);
...
dateValidityPicker(BuildContext context, AddAdvertisementController controller, bool isDarkMode) {
  return showModalBottomSheet(
    context: context,
