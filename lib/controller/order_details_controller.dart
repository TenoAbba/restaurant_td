      ...
      bytes += generator.row([
        ...
        PosColumn(
            text: Constant.amountShow(
                amount:
                    Constant.calculateTax(amount: (double.parse(subTotal.value.toString()) - double.parse(orderModel.value.discount.toString()) - specialDiscount.value).toString(), taxModel: taxModel)
                        .toString()),
            width: 5,
            styles: const PosStyles(
              align: PosAlign.right,
