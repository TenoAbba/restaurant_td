...
class AddProductController extends GetxController {
  ...
  Future<void> saveDetails() async {
    ...
    try {
      if (selectedProductCategory.value.id == null) {
        ...
        for (int i = 0; i < images.length; i++) {
          if (images[i] is XFile) {
            print("[DEBUG SAVE] Uploading image $i: ${images[i].path}");
            ...
            images.removeAt(i);
            images.insert(i, url);
            print("[DEBUG SAVE] Image $i uploaded: $url");
          }
        }
      ...
      print("[DEBUG SAVE] EXCEPTION CAUGHT: $e");
      print("[DEBUG SAVE] STACK TRACE: $stack");
      ShowToastDialog.closeLoader();
      ShowToastDialog.showToast("An error occurred while saving: $e");
    }
  }
